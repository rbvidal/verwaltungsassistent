...
/**
 * Expanded corpus — RUN A: regex semantic parser (baseline).
 */
@SpringBootTest(
...
@DisplayName("Expanded Semantic Corpus — RUN A (regex)")
class ExpandedSemanticCorpusRegexTest extends AbstractExpandedSemanticCorpusTest {
    ...
    protected String reportFileName() {
        return "expanded-corpus-regex.txt";
    }
